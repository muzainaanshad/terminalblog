...
**4. Watch for the dangerous edge cases.** Agents do sometimes do something worse than cruft — like deleting the wrong folder. We documented one reported case where [Claude Code deleted folders unexpectedly](/blog/claude-code-sonnet-5-deletes-folders/). That's not a reason to quit; it's a reason to commit before you let an agent run loose.
