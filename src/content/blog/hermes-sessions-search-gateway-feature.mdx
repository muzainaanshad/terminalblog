...
The feature was merged in PR #57685 by the Hermes team. It runs through the gateway layer, meaning it works across any connected provider and any device. The search is FTS5-backed, the same engine used by SQLite for full-text search — fast, local, no external dependencies.
