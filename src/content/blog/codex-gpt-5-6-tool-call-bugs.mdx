...
updatedDate: "2026-07-11T17:05:00Z"
...
Three bugs, one theme: the new model family is shipping faster than the tool-wiring and entitlement plumbing around it. If you are on Codex and planning to lean on GPT-5.6, verify your workspace tools attach and your account actually has the model before you trust a session. The [Claude Code data-loss writeup](/blog/claude-code-sonnet-5-deletes-folders/) is a reminder that model-version bumps are exactly when agent reliability regresses — watch the tool layer first.
