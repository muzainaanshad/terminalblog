...
Zero is the first coding agent to explicitly support Android. Hermes runs on Windows but doesn't have an Android client. Claude Code requires macOS or Linux. Oh My Pi has no mobile support. Gitlawb Zero is first.
