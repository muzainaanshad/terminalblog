...
Supports Linux, macOS, and Windows on x64 and arm64 — and, as of the latest release, Android via Termux (see the [Termux support writeup](/blog/gitlawb-zero-android-termux-support/)).
...
Unlike agents tied to a specific platform or CI/CD system, Zero works everywhere and answers to no one but you. Its security-first posture is the project's sharpest differentiator: the [0.4.0 sandbox hardening batch](/blog/gitlawb-zero-0-4-0-npm-sandbox/) shows the team treating sandbox denials and least-privilege as first-class concerns, and the [gitlawb-zero vs Codex comparison](/blog/gitlawb-zero-vs-codex/) frames the local-first-versus-cloud-parallelism divide directly. The [runner-hang fix](/blog/gitlawb-zero-askUser-runner-hang-fix/) and the [--auto commit messages feature](/blog/gitlawb-zero-auto-commit-messages/) round out the picture of a project optimizing for trustworthy, owned-by-you daily use.
