...
description: "Anthropic's August 7 Claude Code release lets you run sessions on your own machines, lets agents message each other, and masks JWT and AWS credentials in sandboxed commands. Updated with v2.1.225/226: gateway spend limits, workspace trust prompts, and a wave of reliability fixes."
