...
description: "Hermes Agent v0.20.0, the Herald release, adds streaming hands-free voice with barge-in, Agent-to-Agent (A2A v1.0) interop, signed outbound webhooks, grounded citations, and a desktop plugin SDK. Plain-English breakdown for beginners."
pubDate: "2026-08-08T09:45:00Z"
updatedDate: "2026-08-14T09:45:00Z"
...
The upgrade path: if you're on an older version, `hermes upgrade` picks up Herald automatically. The full changelog lives at [NousResearch/hermes-agent releases](https://github.com/NousResearch/hermes-agent/releases).
