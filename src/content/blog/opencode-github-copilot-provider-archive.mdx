...
- [The Pricing Problem Nobody Talks About in AI Coding Tools](/blog/pricing-problem-ai-coding-tools/)
- [Hermes Agent vs OpenCode: automation or provider-neutral terminal use?](/blog/hermes-vs-opencode/)