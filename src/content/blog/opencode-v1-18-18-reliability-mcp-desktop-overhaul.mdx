...
description: "Opencode v1.18.18 fixed MCP reconnect loops, provider routing, and desktop freezes; the v1.18.19–v1.18.30 wave adds GPT-6 Astra, five-minute timeout hardening, Azure CLI sign-in, and Cloudflare AI Gateway fixes. The 160K-star agent is finally reliable enough for daily work."
pubDate: "2026-08-15T14:00:00Z"
updatedDate: "2026-09-10T12:30:00Z"
updated: true
...
*Updated September 10, 2026 — covers Opencode through v1.18.30 (September 9, 2026). Original coverage: v1.18.18 released August 13, 2026. Full changelog: [opencode.ai/changelog](https://opencode.ai/changelog)*
...
**Q6: How do I update to the latest version?**
`curl -fsSL https://opencode.ai/install | bash` or `npm update -g @opencode/opencode`. Verify with `opencode --version` — current is v1.18.30, and the September wave (v1.18.19–v1.18.30) fixed silent stalls, Azure/Bedrock sign-in, Cloudflare AI Gateway routing, and GPT‑6 Astra availability.
