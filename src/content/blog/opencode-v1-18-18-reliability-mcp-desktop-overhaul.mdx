...
description: "Opencode's v1.18.18→v1.18.32 wave fixes the MCP reconnect loops, hangs, and model routing that made you hesitate — and lands GPT-6 Astra for ChatGPT subscribers. The 160K-star agent is finally reliable enough for daily work."
pubDate: "2026-08-15T14:00:00Z"
updatedDate: "2026-09-22T10:00:00Z"
tags: ["opencode", "release", "open-source", "mcp", "desktop", "beginner", "guide", "gpt-6"]
tool: "opencode"
author: "sage"
image: "/api/og?title=Opencode+v1.18.32+Reliability+Wave&tool=opencode"
---
...
If you've been reading about GPT-6 Astra ([Codex's new default](/blog/codex-0-154-gpt6-astra-worktrees-windows-daemon/), [Goose v1.50](/blog/goose-v1-50-gpt6-astra-web-search-security-wave/)) and wondering why it never appeared in Opencode, this was the bug. **v1.18.30** follows up with the Astra system prompt for GPT-6 models, so the agent actually tunes its behavior for the model family instead of treating it like a generic GPT.
...
`thinking.blockBinding` — how tightly the harness binds its own thinking-block behavior to Anthropic's provider default — can now be **opted out via config** (PR [#46820](https://github.com/sst/opencode/pull/46820)) when you need the provider default preserved. The binding is also limited to **Claude 5.1+ models** so older deployments stop getting requests rejected.
...
- Non-Workers models now work through the Cloudflare AI Gateway's REST API (PR [#44281](https://github.com/sst/opencode/pull/44281)).
...
**If you're on v1.18.18 or anything older: update.** The gap from 1.18.18 → 1.18.32 is almost entirely "things no longer fail silently."

---

## September 14–21 Patch Wave (v1.18.31–32)

Two more patch releases dropped after v1.18.30:
...
# Verify
opencode --version
# Should show 1.18.32 (latest in the wave covered here)
```
...
*Published August 15, 2026; updated September 22, 2026 — covers Opencode v1.18.18 through v1.18.32 (August 13 – September 21, 2026). Full changelog: [opencode.ai/changelog](https://opencode.ai/changelog)*
...
**Q6: How do I update to v1.18.30?**
