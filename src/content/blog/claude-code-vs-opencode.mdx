...
description: "Claude Code versus OpenCode (claude-code/opencode, slug claude-code-vs-opencode) for open source vs commercial coding agent operator fit. Jobs: Deep reasoning · Provider-neutral terminal use. Operator verdict + matrix + rubric."
