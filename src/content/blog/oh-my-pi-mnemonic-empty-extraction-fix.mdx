...
The commit (b24052b in the `farm/cf3baff7` branch) modifies the structured extraction parser to preserve empty values. The pipeline now treats empty arrays, null fields, and empty strings as valid values rather than omitting them.
