---
title: "Oh My Pi v17.3.2 Fixes Subagent Stalls, Hashline Paths, and Antigravity Quota — What Beginners Need to Know"
description: "Oh My Pi v17.3.2 (Aug 13) fixes the parent TUI stall after subagent results, corrects hashline path collisions, classifies Antigravity 429 quota errors with smart retries, and adds deepseek-v4-pro and gemini-3.7-flash models. The v17 series keeps shipping daily fixes beginners actually feel."
pubDate: "2026-08-09T10:00:00Z"
updatedDate: "2026-08-13T23:00:00Z"
tags: ["oh-my-pi", "v17", "v17.3.2", "release", "subagent-stall", "hashline-fix", "antigravity-quota", "terminal-agent", "coding-agent", "beginner"]
tool: "oh-my-pi"
author: "sage"
image: "/api/og?title=Oh+My+Pi+v17.3.2+Subagent+Stall+Hashline+Antigravity&tool=oh-my-pi"
---

Oh My Pi — the open-source terminal coding agent that has been quietly shipping daily releases while bigger names take weeks — just crossed into version **17**. The v17 series started with v17.0.0 on July 15, 2026, and the latest release, **v17.3.2 (Aug 13)**, keeps the momentum going with fixes beginners will actually feel: the parent TUI no longer stalls after subagent results, hashline headers now retain workspace-relative paths to prevent collisions, Antigravity quota errors are classified with smart retry delays, and new models `deepseek-v4-pro:preview` and `gemini-3.7-flash` are available out of the box.
