...
description: "OpenClaw 2026.7.1-2 and 2026.6.34 (Aug 3–8) harden the gateway, fix Codex subagent stalls, add safer browser boundaries, and recover sessions through restarts. September's 2026.9.1–9.6 add GPT-6 Astra, durable approvals, shareable conversation links, Team Reports, and macOS app rebuild. The control-plane vision — driving Codex, Claude, OpenCode, and Pi from one cockpit — is now shipping in stable."
...
**Safer browser and network boundaries**: Sandboxed browser routes, trusted DNS targets, custom browser origins, and loopback provider endpoints now reject unsafe access paths. The browser sandbox is no longer a suggestion. This sandboxing approach mirrors what we've seen in [Cursor's sandboxed office agent](/blog/cursor-sand-office-agent-anthropic-r4/) — containment over trust.
...
## v2026.9.5 and v2026.9.6 — Extended-Stable and macOS App Rebuild (Sep 19–23)

The September wave continues with two critical releases:

**v2026.9.5 (Sep 19)** — Extended-stable release with 64 direct commits, 4,179 pull requests, and 503 contributors. This is the "LTS-equivalent" line — OpenClaw from end of July plus critical security updates, reliability and performance fixes, and new model support. The current latest is now 2026.9.6.

**v2026.9.6 (Sep 23, macOS app rebuilt Sep 24)** — The macOS app was rebuilt after the original 2026.9.6 build crashed at launch (#156861) and was replaced at 09:52 UTC by a rebuilt, notarized 2026.9.6 build with the fix (#156881). If you installed the earlier 2026.9.6 build and it crashed on launch, download the DMG again or update from 2026.9.5 in the app.

This release includes the full September feature wave: GPT-6 Astra support, durable approvals, shareable conversation links, Team Reports, update rehearsal, Skill Workshop, meeting library, and the Node 24.16+/26.1+ requirement.
...
# Docker
docker pull openclaw/openclaw:2026.9.6
