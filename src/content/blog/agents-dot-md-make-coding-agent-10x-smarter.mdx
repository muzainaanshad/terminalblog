...
**Q1: What is AGENTS.md and why does it matter?**
...
**Q3: What's the minimum viable AGENTS.md?**
At minimum: project overview, stack, commands (install, dev, test, lint, build), architecture (where features live, what not to create), safety rules (never commit secrets, never force-push, run tests before claiming done), and style preferences. Keep it to 30-50 lines — agents respect token limits and read top to bottom.

**Q4: How do I verify the agent is actually reading my AGENTS.md?**
...
No. AGENTS.md is **advice the model is asked to follow**; a permission system is an **enforced gate the model cannot bypass**. Put intent in AGENTS.md ("never force-push main") and enforcement in the harness (deny `git push --force`, require approval for destructive actions).

**Q6: What's the difference between AGENTS.md and a skill file (SKILL.md)?**
