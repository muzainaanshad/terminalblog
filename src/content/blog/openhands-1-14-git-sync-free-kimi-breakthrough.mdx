...
description: "OpenHands 1.14–1.17: a Git Sync automation page, free Kimi K3 as the default Canvas model, LLM provider switching, self-hosted Linux desktops, conversation tags, and automations that ship their own scripts."
pubDate: 2026-08-18
