...
Claude Code is the only coding agent with a dedicated frontend-design skill. Hermes has skills for code review and security audit. OpenCode has community skills. But the frontend-design skill is unique to Claude Code — and it's a glimpse at where all coding agents are heading.
