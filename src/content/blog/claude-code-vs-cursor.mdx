...
description: "Claude Code versus Cursor (claude-code/cursor, slug claude-code-vs-cursor) for IDE vs terminal coding agent daily driver. Jobs: Deep reasoning · Daily interactive coding. Operator verdict + matrix + rubric."
