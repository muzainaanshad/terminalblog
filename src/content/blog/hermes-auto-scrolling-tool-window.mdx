...
Hermes is the first coding agent to ship this. OpenCode, Mimo, Kilo — none of them have auto-scrolling tool-call windows. This is the kind of UX attention that separates a tool you use from a tool you love.
