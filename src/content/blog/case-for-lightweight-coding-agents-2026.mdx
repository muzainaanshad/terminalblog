...
- **Token economy** — minimal context means minimal spend, which matters when the agent runs dozens of times a day.
- **Low cognitive overhead** — no new interface to learn, no complex command vocabulary to remember.
