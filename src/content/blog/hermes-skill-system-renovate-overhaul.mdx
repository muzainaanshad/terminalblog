...
Hermes's skill system just got a major overhaul. The `skills-renovate` branch (merged in PR #57590) touches nearly every part of the skill infrastructure — loading, caching, validation, dependency resolution, and cross-skill references.
