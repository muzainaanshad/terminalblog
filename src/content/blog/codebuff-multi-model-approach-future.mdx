...
description: "Codebuff routes each request to the model that fits it — orchestration instead of a single provider. Being model-agnostic isn't just a feature, it's survival: this is why multi-model approaches are the future of AI coding agents."
