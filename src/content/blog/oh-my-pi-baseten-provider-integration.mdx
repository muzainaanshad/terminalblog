...
The commit (4c18cc1) integrated Baseten into Oh My Pi's model catalog and provider definitions. For users, it means one more option in the provider picker — but it's an option that changes the economics of running open models.
