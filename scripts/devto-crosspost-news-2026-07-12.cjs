#!/usr/bin/env node
// Cross-post the 2026-07-12 viral news roundup articles to Dev.to
// Same pattern as devto-crosspost.cjs
const fs = require('fs');
...
const slugs = [
  'microsoft-365-copilot-gpt-5-6-default',
  'unsloth-qwen3-6-quantization-2-5x-gpu',
  'kraken-agentic-trading-bots-mobile',
  'tencent-hy3-coding-ai-014-token',
  'google-ai-studio-github-import-autodeploy',
];
