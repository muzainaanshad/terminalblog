#!/usr/bin/env node
// Cross-post the 2026-07-13 "Just Shipped" OpenClaw article to Dev.to
// Same pattern as devto-crosspost-justshipped-2026-07-12.cjs
const fs = require('fs');
...
const slugs = [
  'openclaw-just-shipped-session-scrollback-settings-search',
];
