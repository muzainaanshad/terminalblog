#!/usr/bin/env node
// Cross-post the 2026-07-13c "Just Shipped" commit-roundup articles to Dev.to
const fs = require('fs');
...
const slugs = [
  'oh-my-pi-just-shipped-tan-fork-isolation-persistent-launcher',
  'openclaw-just-shipped-session-history-oauth-compaction-sms-quota',
];
