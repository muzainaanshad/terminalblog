#!/usr/bin/env node
// Cross-post the 2026-07-13e "Just Shipped" commit-roundup articles (Stream 1) to Dev.to
const fs = require('fs');
...
const slugs = [
  'openclaw-just-shipped-ios-v3-oauth-voice-gateway-fixes',
  'hermes-just-shipped-desktop-approval-whatsapp-session-fixes',
  'codex-just-shipped-mcp-timeouts-skill-selection-multi-agent',
];
