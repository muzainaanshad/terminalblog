#!/usr/bin/env node
// Cross-post the 2026-07-13f "Just Shipped" commit-roundup articles (Stream 1) to Dev.to
const fs = require('fs');
...
const slugs = [
  'goose-just-shipped-deepseek-reasoning-streaming-hardening',
  'openclaw-just-shipped-sidebar-catalog-sessions-control-ui',
  'gitlawb-zero-just-shipped-sandbox-turn-budgets-config',
  'hermes-just-shipped-durable-background-completions',
  'codex-just-shipped-oauth-store-lock-contention-tests',
];
