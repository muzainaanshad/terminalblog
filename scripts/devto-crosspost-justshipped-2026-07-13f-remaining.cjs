#!/usr/bin/env node
// Cross-post ONLY the remaining 2026-07-13f "Just Shipped" articles to Dev.to
// (goose + openclaw already posted in the first run)
const fs = require('fs');
...
// Only the three that have NOT yet been posted
const slugs = [
