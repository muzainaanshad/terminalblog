#!/usr/bin/env node
// Cross-post the 2026-07-13 "Just Shipped" OpenClaw + oh-my-pi articles to Dev.to
// Same pattern as devto-crosspost-justshipped-2026-07-13.cjs
const fs = require('fs');
...
const slugs = [
  'openclaw-just-shipped-plugin-registry-decompose-usage-filters',
  'oh-my-pi-just-shipped-floating-model-select-browser-safety',
];
