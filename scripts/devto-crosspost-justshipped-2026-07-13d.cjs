#!/usr/bin/env node
// Cross-post the 2026-07-13 "Just Shipped" commit-roundup articles (Stream 1) to Dev.to
const fs = require('fs');
...
const slugs = [
  'openclaw-just-shipped-ui-gateway-plugin-sdk-fixes',
  'hermes-just-shipped-actionable-kanban-approval-hooks-fixes',
];
