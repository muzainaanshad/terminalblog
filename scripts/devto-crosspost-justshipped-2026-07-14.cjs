#!/usr/bin/env node
// Cross-post the 2026-07-14 "Just Shipped" commit-roundup articles (Stream 1) to Dev.to
const fs = require('fs');
...
const slugs = [
  'openclaw-just-shipped-channels-wizard-gateway-refactors',
  'hermes-just-shipped-gateway-drain-compression-lock-auth-fixes',
  'codex-just-shipped-windows-console-pid-reap-agent-identity',
];
