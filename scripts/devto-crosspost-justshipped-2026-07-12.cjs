#!/usr/bin/env node
// Cross-post the 2026-07-12 "Just Shipped" commit-roundup articles to Dev.to
...
const slugs = [
  'openclaw-just-shipped-refactor-clawhub-updates',
  'hermes-just-shipped-fallback-editor-approval-fixes',
  'oh-my-pi-just-shipped-ast-auto-wrap',
];
