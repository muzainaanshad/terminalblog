#!/usr/bin/env node
// Cross-post the 2026-07-12 (late) "Just Shipped" commit-roundup articles to Dev.to
const fs = require('fs');
...
const slugs = [
  'openclaw-just-shipped-message-transport-request-policy-fixes',
  'gitlawb-zero-just-shipped-credstore-and-plugin-fixes',
];
